...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
    ...
    private static boolean isProcessingResultInProgress;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PEOPLE) {
                ...
                String chatName = selectedUsers.get(0).getFullName();
    ...
    private void userLogout() {
        ...
        Choose_Sign_Up_type.start(DialogsActivity.this);
    ...
    private void initUi() {
        System.out.println("dsdsdsdsdsd "+currentUser.getId());
    ...
    public  void createDialog(final ArrayList<QBUser> selectedUsers, String chatName) {
    ...
    public static class DialogJoinerAsyncTask extends BaseAsyncTask<Void, Void, Void> {
        ...
        public DialogJoinerAsyncTask(DialogsActivity dialogsActivity, ArrayList<QBChatDialog> dialogs, boolean clearDialogHolder) {
