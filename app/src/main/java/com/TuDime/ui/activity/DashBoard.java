...
import com.TuDime.ui.fragments.Calls_Fragment;
import com.TuDime.ui.fragments.Chat_Fragment;
import com.TuDime.ui.fragments.Contact_chat_Fragment;
import com.TuDime.utils.Constant;
import com.TuDime.constants.Consts;
import com.TuDime.utils.InternetConnection;
...
import static com.TuDime.ui.activity.SignUpActivity.hasPermissions;
            ...
            FirebaseMessaging.getInstance().getToken()
                    .addOnCompleteListener(new OnCompleteListener<String>() {
                        ...
                        public void onComplete(@NonNull Task<String> task) {
                            ...
                            Global_FCM_TOKEN =token;
                            Log.e("@@",Global_FCM_TOKEN);
                            try {
