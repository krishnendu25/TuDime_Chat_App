...
public class VolleyMultipartRequest_ extends Request<JSONObject> {
    ...
    public VolleyMultipartRequest_(String url, Map<String, String> headers,
    ...
    public VolleyMultipartRequest_(int method, String url,
                                   Response.Listener<JSONObject> listener,
                                   Response.ErrorListener errorListener) {
