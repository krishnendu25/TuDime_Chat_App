...
import obj.quickblox.sample.chat.java.util.NetworkConnectionChecker;
...
import static obj.quickblox.sample.chat.java.utils.Consts.MAX_OPPONENTS_COUNT;


public class CallService extends Service {
    private static final String TAG = CallService.class.getSimpleName();

    private static final int SERVICE_ID = 845;
    private static final String CHANNEL_ID = "Quickblox ";
    private static final String CHANNEL_NAME = "Quickblox background ";
    ...
    public void onCreate() {
        ...
        initListeners();
        initAudioManager();
        ringtonePlayer = new RingtonePlayer(this, R.raw.phone_ring);
        super.onCreate();
    }
